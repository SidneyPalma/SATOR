 ...
 */
Ext.define( 'Smart.util.IonSound', {

    singleton: true,

    alternateClassName: ['Smart.ion'],
    ...
    init: function (window, navigator) {
        ...
        if (typeof Audio !== "function" && typeof Audio !== "object") {
            ...
            Smart.ion.sound = func;
            Smart.ion.sound.play = func;
            Smart.ion.sound.stop = func;
            Smart.ion.sound.pause = func;
            Smart.ion.sound.preload = func;
            Smart.ion.sound.destroy = func;
            func();
            return;
        }
        ...
        Smart.ion.sound = function (options) {
        ...
        Smart.ion.sound.VERSION = "3.0.7";

        Smart.ion.sound._method = function (method, name, options) {
            if (name) {
        ...
        Smart.ion.sound.preload = function (name, options) {
            options = options || {};
            extend({preload: true}, options);

            Smart.ion.sound._method("init", name, options);
        };

        Smart.ion.sound.destroy = function (name) {
            Smart.ion.sound._method("destroy", name);
        ...
        Smart.ion.sound.play = function (name, options) {
            Smart.ion.sound._method("play", name, options);
        };

        Smart.ion.sound.stop = function (name, options) {
            Smart.ion.sound._method("stop", name, options);
        };

        Smart.ion.sound.pause = function (name, options) {
            Smart.ion.sound._method("pause", name, options);
        };

        Smart.ion.sound.volume = function (name, options) {
            Smart.ion.sound._method("volume", name, options);
        };
